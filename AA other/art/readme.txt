...
I heard you liked the game. Or maybe you didn't. You might not have even played it yet.
...
I suggest using Paint, paint.net, or Photoshop to open these files, but any image editor should work.
...
wav files can be opened in anything that can open audio files. It's like the sound equivalent of a PNG.
I recommend VLC, but Windows Media Player or similar should work.